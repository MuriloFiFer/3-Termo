...
<body>
    ...
    <!-- Incluindo novo campo para pesquisa  -->
    <div class="content read">
    <form class="" id="searchForm" action="" method="get">
            <label for="search">Pesquisar por nome do cliente:</label>
            <select id="search" name="search">
                ...
                <?php
                    ...
                    // Preparar a consulta SQL para obter os sabores de pizza
                    $stmt = $pdo->query('SELECT DISTINCT nome FROM contatos');
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                <tbody>
                    <?php foreach ($contacts as $contact): ?>
                        <tr>
                            ...
                            <td class="actions">
                    <a href="alterar_entrega.php?id=<?=$contact['id_contato']?>" class="edit"><i class="fas fa-pen fa-xs"></i></a>
                    <a href="apagar_entrega.php?id=<?=$contact['id_contato']?>" class="trash"><i class="fas fa-trash fa-xs"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
                </tbody>
