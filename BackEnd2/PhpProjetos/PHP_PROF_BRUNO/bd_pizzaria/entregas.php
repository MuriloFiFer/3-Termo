...
// Preparar a instrução SQL e obter registros da tabela entregas, LIMIT irá determinar a página
$stmt = $pdo->prepare('SELECT * FROM entregas ORDER BY id_contato OFFSET :offset LIMIT :limit');
...
<?=template_header('Visualizar Status de Pedidos')?>

<div class="content read">
	<h2>Visualizar Status de Pedidos</h2>
	...
	<div class="pagination">
		<?php if ($page > 1): ?>
		<a href="entregas.php?page=<?=$page-1?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
		<?php endif; ?>
		<?php if ($page*$records_per_page < $num_contacts): ?>
		<a href="entregas.php?page=<?=$page+1?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
		<?php endif; ?>
	</div>
</div>
